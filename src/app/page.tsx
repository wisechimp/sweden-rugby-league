    ...
    <div>
      ...
      <div className={'pageMainParagraph'}>
        <p>
          ...
          <Link href="https://europeanrugbyleague.com/" target="_blank" rel="noopener noreferrer">
            European Rugby League
          </Link>{' '}
          in 2011 as Observer members. They oversee the{' '}
          <Link href="/clubs">national competition</Link> in Sweden and the national team who were{' '}
          <Link href="https://intrl.sport/world-rankings" target="_blank" rel="noopener noreferrer">
            ranked 32nd
          </Link>{' '}
